    ...
    **Args**:
    ...
    try:
        ...
        if shouldLog:
            ...
            reduction_percentage = ((original_size - encoded_size) / original_size) * 100

            Logger.info(f"INFO: Text compressed and encoded with {reduction_percentage:.2f}% size reduction.")
